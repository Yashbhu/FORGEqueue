...
const (
	QueueService_EnqueueTask_FullMethodName = "/queue.v1.QueueService/EnqueueTask"
)
...
func (c *queueServiceClient) EnqueueTask(ctx context.Context, in *EnqueueTaskRequest, opts ...grpc.CallOption) (*EnqueueTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, QueueService_EnqueueTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
